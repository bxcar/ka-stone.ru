...
<head>
	...
	if( get_field('favicon', 'option') ) {
		...
		echo'<link rel="shortcut icon" href="'.get_template_directory_uri().'/favicon1.ico" type="image/x-icon">';
	}
	?>	
...
<!--							--><?php //if( get_field('email', 'option') ) { echo '<a href="mailto:'.get_field('email', 'option').'" class="mailto">'.get_field('email', 'option').'</a>'; } ?>
                            <div class="call-box">
                                <?php if( get_field('head_tel', 'option') ) { echo '<a href="'.get_field('head_tel', 'option').'" class="number-call" style="margin-right: 10px;">'.get_field('head_tel', 'option').'</a>'; } ?>
                            </div>
							<div class="call-box">
								<?php if( get_field('consult_tel', 'option') ) { echo '<a href="tell:'.get_field('consult_tel', 'option').'" class="number-call" style="margin-right: 10px;">'.get_field('consult_tel', 'option').'</a>'; } ?>
							</div>
                        ...
                        <div class="item header-phones-wrap">
                            <div class="item-header-phones">
                                ...
                                <div class="header-phones">
                                    <span class="header-phone"><?= get_field('head_tel', 'option'); ?></span>
                                    <span class="header-phone"><?= get_field('consult_tel', 'option'); ?></span>
                                </div>
                            </div>
