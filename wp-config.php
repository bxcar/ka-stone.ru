...
define( 'WP_HOME', 'http://ka-stone.ru');
define( 'WP_SITEURL', 'http://ka-stone.ru');
define('DB_NAME', 'kastonn9_kastone');

/** Имя пользователя MySQL */
define('DB_USER', 'kastonn9_kastone');

/** Пароль к базе данных MySQL */
define('DB_PASSWORD', 'DS8pg68&');
